		...
		<section class="login_contract">
			 ...
			 <?php
				...
				if ($id_plan == '1' || $id_plan == '2' || $id_plan == '3'){
					$sql = "SELECT * FROM planes WHERE idPlan=$id_plan";
 		 		...
 		 		<div class="row">
 		 			<div class="col offset-m2 m8 offset-l2 l8">
 		 				<div class="card-panel teal lighten-2 center-align">
 							 <blockquote><?php echo "Plan " . $r["nombre"] . ", " . $r["usuarios_max"] . " usuarios, " . $r["ordenes_max"] . " ordenes."?></blockquote>
 						</div>
 					</div>
 				</div>
 				<div class="row">
 					<div class="container col s12 m12 offset-l1 l3 z-depth-2" id="hijoUno"> <br> <br>
 						<div class="switch col offset-s4 s2 offset-m2 m8 l12 center-align">
 		 				...
 		 				<div class="section">
 	 			 			<input type="hidden" name="id_plan" value="<?php echo $id_plan;?>" id="id_plan"/>
 	 			 				<div class="container"> <br> <br> <br>
 	 			 				<div class="col s12 m12 l12 center-align">
  			 						<input type="radio" name="pagando" value="1" id="radioUno">
  			 						<b class="total"><?php echo $r["pago_anual"]*12?></b><br><br>
							...
							<input type="hidden" name="id_plan" value="<?php echo $id_plan;?>" id="id_plan"/>
		 					<div class="container"><br><br><br>
	 		 			 		<div class="col s12 m12 l12 center-align">
	 				 				...
	 				 				<b class="total"><?php echo $r["pago_semestral"]*6?></b><br><br>
							...
							<input type="hidden" name="id_plan" value="<?php echo $id_plan;?>" id="id_plan"/>
	 					 	<div class="container"> <br> <br> <br>
		 		 			   	<div class="col s12 offset-m2 m8 l12 center-align">
	 					 			...
	 					 			<b class="total"><?php echo $r["pago_mensual"]?></b><br><br>
					...
					<h3 class="indigo-text text-lighten-1">Datos personales</h3>
						<div class="row">
							<div class="input-field col l6">
								...
								<input type="text" id="nombre_p" name="nombre_p" value="<?php echo $_REQUEST['nombre_p'];?>" class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Primer y segundo nombre"  title="El nombre solo puede contener letras, no numeros" data-length="30" required>
								<div id="info_name"></div>
							</div>
							<div class="input-field col l6">
								<label for="">Apellido</label>
								<input type="text" name="apellido_p" id="apellido_p" value="<?php echo $_REQUEST['apellido_p'];?>"  title="El apellido solo puede contener letras, no numeros" data-length="25">
								<div id="info_surname"></div>
							</div>
						</div>
						<div class="row">
							<div class="input-field col l4">
								<input type="email" name="email_p" id="email_p" value="<?php echo $_REQUEST['email_p'];?>" class="validate" required>
							...
							<div class="input-field col l4">
								...
								<input type="text" name="cargo_p" id="cargo_p" value="<?php echo $_REQUEST['cargo_p'];?>" required>
							</div>
							<div class="input-field col l4">
								<label for="">Tel/cel</label>
								<input type="number" name="tel_p" id="tel_p" value="<?php echo $_REQUEST['tel_p'];?>" placeholder=""  class="validate">
							</div>
							</div>
						</div>
				</div>
					...
					<h3 class="indigo-text text-lighten-1">Datos empresa</h3>
						<div class="row">
							<div class="input-field col l3">
								...
								<input type="text" name="nombre_em" id="nombre_em" value="<?php echo $_REQUEST['nombre_em'];?>"  data-length="30" required>
							...
							<div class="input-field col l3">
								 <select id="rubro" name="rubro">
		                                <option value="" selected>Elija una opción</option>
			                                <?php
				                                $sql2 = "SELECT idRubro, nombreRubro FROM admins_rubros"; 
				                                    $rs2 = mysqli_query($conexion, $sql2);
				                                    if ($rs2){
				                                        while ($r2 = mysqli_fetch_array($rs2)){
			                                ?>
                                      		<option value="<?php echo $r2["idRubro"];?>"><?php echo $r2["nombreRubro"]; ?> </option>
			                                <?php                                        
			                                        }
			                                    } 
			                                ?>
							...
							<div class="input-field col l3">
								<input type="email" name="email_em" id="email_em" value="<?php echo $_REQUEST['email_em'];?>"  class="validate" required>
							...
							<div class="input-field col l3">
								...
								<input type="number" name="tel_em" id="tel_em" value="<?php echo $_REQUEST['tel_em'];?>" placeholder=""  required>
							</div>
						</div>
						<div class="row">
							<div class="input-field col l3">
								<label for="">Direccion</label>
								<input type="text" name="direccion_em" id="direccion_em" value="<?php echo $_REQUEST['direccion_em'];?>"  required>
							</div>
							<div class="input-field col l3">
								<label for="">Ciudad</label>
								<input type="text" name="ciudad_em" id="ciudad_em" value="<?php echo $_REQUEST['ciudad_em'];?>"  required>
							</div>
							<div class="input-field col l3">
								<label for="">Provincia</label>
								<input type="text" name="provincia_em" id="provincia_em" value="<?php echo $_REQUEST['provincia_em'];?>"  required>
							</div>
							<div class="input-field col l3">
								<label for="pais_em">Pais</label>
								<input type="text" name="pais_em" id="pais_em" value="<?php echo $_REQUEST['pais_em'];?>"  required>
							</div>
						</div>
						<br>
						<textarea id="comentario_gral" name="comentario_gral" value="<?php echo $_REQUEST['comentario_gral'];?>" class="materialize-textarea"  data-length="300"></textarea>
						...
						<h3 class="indigo-text text-lighten-1">Datos Login</h3>
							<div class="row">
								<div class="input-field col l6"><!--http://www.forosdelweb.com/f18/expresion-regular-acepte-numeros-letras-solo-numeros-pero-no-solo-letras-1044069/    https://developer.mozilla.org/es/docs/Web/JavaScript/Guide/Regular_Expressions-->
									...
									<input type="text" class="validate" id="user" name="user" value="<?php echo $_REQUEST['user'];?>"  data-length="20" required>
