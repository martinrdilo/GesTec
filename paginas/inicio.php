    ...
    <section id="showbox" class="valign-wrapper row container">
        <div class="section center-align col s12 m12 l12">
            <h3 class="white-text">GESTOR DE REPARACIONES</h3>
                ...
                <span class="<?= $pagina == 'login' ? 'active' : ''; ?>"><a href="?p=login" class="light-blue-text text-lighten-5 waves-effect waves-green btn">INGRESAR</a></span>
        </div>
    </section>
    <section class="container">
        ...
        <div class="section grey lighten-1 z-depth-3">
            <h4 class="center-align">Planes a Medida</h4>
                ...
                <div class="center-align <?= $pagina == 'planes' ? 'active' : ''; ?>"><a href="?p=planes" class="waves-effect btn deep-orange pulse">Elige el tuyo</a></div>
        </div>
        </div>
